...
|---|---|---|
| Unit/Integration (Vitest) | 59 | 507 |
| E2E (Playwright) | 29 | 117 |
| **Total** | **88** | **624** |
...
- **Lib**: `sentry.test.ts` (3 tests), `sentry.unit.test.ts` (47 tests), `retry.test.ts` (6 tests), `track-event-server.test.ts` (5 tests), `track-event.test.ts` (3 tests)
