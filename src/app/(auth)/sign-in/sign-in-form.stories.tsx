...
// SignInForm depends on Supabase, next/navigation, and next/dynamic at runtime.
        ...
        <form className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-accent underline underline-offset-4 cursor-pointer">
                Forgot password?
              </span>
            </div>
            <Input
  ...
  render: () => (
    <Card>
      ...
      <CardContent>
        <form className="flex flex-col gap-3">
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="email-prefilled">Email</Label>
            <Input
              id="email-prefilled"
              type="email"
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center justify-between">
              <Label htmlFor="password-prefilled">Password</Label>
              <span className="text-xs text-accent underline underline-offset-4 cursor-pointer">
                Forgot password?
              </span>
            </div>
            <Input
              id="password-prefilled"
              type="password"
              placeholder="••••••••"
              autoComplete="current-password"
            />
  ...
  render: () => (
    <Card>
      ...
      <CardContent>
        <form className="flex flex-col gap-3">
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="email-confirmed">Email</Label>
            <Input
              id="email-confirmed"
              type="email"
              placeholder="you@example.com"
  ...
  render: () => (
    <Card>
      ...
      <CardContent>
        <form className="flex flex-col gap-3">
          <div className="flex flex-col gap-1.5">
            <Label htmlFor="email-oauth-error">Email</Label>
            <Input
              id="email-oauth-error"
              type="email"
              placeholder="you@example.com"
              autoComplete="email"
            />
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center justify-between">
              <Label htmlFor="password-oauth-error">Password</Label>
              <span className="text-xs text-accent underline underline-offset-4 cursor-pointer">
                Forgot password?
              </span>
            </div>
            <Input
              id="password-oauth-error"
              type="password"
              placeholder="••••••••"
              autoComplete="current-password"
            />
          ...
          <p className="text-xs text-destructive" role="alert">
            OAuth callback failed: access_denied
          </p>
          <Button type="button" className="mt-1">
            Sign in
          </Button>
