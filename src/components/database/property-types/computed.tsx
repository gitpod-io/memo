...
export function CreatedTimeRenderer({ value }: RendererProps) {
  ...
  return (
    <Tooltip>
      <TooltipTrigger className="truncate text-sm text-muted-foreground" data-testid="cell-renderer-created_time">
        {label}
      </TooltipTrigger>
...
export function UpdatedTimeRenderer({ value }: RendererProps) {
  ...
  return (
    <Tooltip>
      <TooltipTrigger className="truncate text-sm text-muted-foreground" data-testid="cell-renderer-updated_time">
        {label}
      </TooltipTrigger>
      <TooltipContent>{full}</TooltipContent>
    </Tooltip>
...
export function CreatedByRenderer({ value, property }: RendererProps) {
  ...
  return (
    <Tooltip>
      <TooltipTrigger className="flex items-center gap-1.5" data-testid="cell-renderer-created_by">
        {creator.avatar_url ? (
          <img
